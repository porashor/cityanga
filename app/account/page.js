...
const page = () => {
  ...
  return Object.keys(accountdata).length > 0 ? (
    <div className="bg-white dark:bg-[#213a54] py-5 md:py-10">
      <div className="w-[90%] md:w-[80%] mx-auto my-5 md:my-10 bg-[#f5f5f5] dark:bg-[#192c3f] py-5 md:py-10 text-black dark:text-white px-2 rounded-xl flex">
        <div className="flex flex-col items-start mx-2 md:mx-5 justify-center gap-3 md:gap-5 w-[300px] md:w-[350px] lg:w-[400px] text-xl border-r border-slate-400">
          <Image
            alt=""
            width={200}
            height={200}
